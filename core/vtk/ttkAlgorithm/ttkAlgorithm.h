...
public:
  ...
  /**
   * Set the buffer size of the AcTopo.
   */
  ...
  /**
   * Set the working mode for the AcTopo.
   */
  ...
  /**
   * Set the number of producers to be used for the AcTopo.
   */
  void SetProducerNumber(int num) {
