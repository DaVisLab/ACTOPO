...
int ttkDiscreteGradient::RequestData(vtkInformation *request,
  ...
  this->printMsg("Time usage for reading the mesh: " + to_string(timer.getElapsedTime()) + " s.");
  this->printMsg("Memory usage after reading mesh: " + to_string(m.getValue_in_MB(false)) + " MB.");
  timer.reStart();
  ...
  this->printMsg("Time usage for preprocessing: " + to_string(timer.getElapsedTime()) + " s.");
  this->printMsg("Memory usage after preprocessing: " + to_string(m.getValue_in_MB(false)) + " MB.");
  timer.reStart();
  ...
  this->printMsg("Time usage for computation: " + to_string(timer.getElapsedTime()) + " s.");
  this->printMsg("Memory usage for computation: " + to_string(m.getValue_in_MB(false)) + " MB.");
