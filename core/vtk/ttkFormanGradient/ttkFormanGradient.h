...
///
/// \ingroup vtk
/// \class ttkFormanGradient
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::FormanGradient module.
///
/// This VTK filter uses the ttk::FormanGradient module to compute an averaging
...
///   - standalone/FormanGradient/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::FormanGradient
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkFormanGradientModule.h>
...
class TTKFORMANGRADIENT_EXPORT ttkFormanGradient
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::FormanGradient // and we inherit from the base class
{
private:
  /**
...
public:
   ...
   */
  static ttkFormanGradient *New();
  vtkTypeMacro(ttkFormanGradient, ttkAlgorithm);
